...
@section('content')
    ...
    <section id="social-media-marketing" class="p-4 m-3 p-mt-head border border-primary rounded-3">
        <h3 style="text-align: right; ">!<strong> بدون دردسر Canva اکانت</strong></h3>
        <p class="p-product text-end">
            با توجه به محدودیت‌های موجود برای کاربران ایرانی در دسترسی بهتر Canva ما فرآیند ثبت‌نام و خرید را برای شما
            آسان
                        ...
                        <div class="row">
                            @foreach ($products as $product)
                                <div class="col-12 mb-4">
                                    <a href="{{ route('customer.doc.canva.detail', ['slug' => $product->slug]) }}"
                                        class="text-decoration-none text-dark">
                                        <div class="card custom-card h-100" itemscope itemtype="https://schema.org/Product">
                                            <div class="text-center p-4">
                                                <img src="/customer/images/canva.webp" class="card-img-top"
                                    ...
                                    <a href="{{ route('customer.doc.canva.detail', ['slug' => $product->slug]) }}"
                                        ...
                                        <div class="desktop-product-card">
                                            <div class="desktop-product-image">
                                                <img src="/customer/images/canva.webp" alt="{{ $product->name }}"
                                                    title="{{ $product->name }}">
                                            </div>
